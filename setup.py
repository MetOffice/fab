...
setuptools.setup(
    ...
    entry_points={'console_scripts': ['fab=fab.builder:fab_entry',
                                      'fab-grab=fab.grabber:grab_entry',
                                      'fab-dump=fab.dumper:dump_entry'],
                  'gui_scripts': ['fab-explorer=fab.explorer:explorer_entry']},

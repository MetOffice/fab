...
class TestCleanupPrebuilds(object):
    ...
    def test_init_no_args(self):
        with mock.patch('fab.steps.cleanup_prebuilds.file_walk', return_value=[Path('foo.o')]), pytest.warns(UserWarning, match="_metric_send_conn not set, cannot send metrics"):

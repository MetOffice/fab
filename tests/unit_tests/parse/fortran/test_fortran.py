...
class TestAnalysedFortran(object):
    ...
    def analysed_fortran(self):
        return AnalysedFortran(
            ...
            symbol_deps=['other_mod1',
                         'other_mod2',
                         'other_func1',
                         'other_func2'],
            mo_commented_file_deps=['my_file.c'],
            file_deps=[Path('other_mods.f90')],
    ...
    def different_mo_commented_file_deps(self):
        return AnalysedFortran(
            ...
            symbol_deps=['other_mod1',
                         ...
                         'other_func1',
                         'other_func2'],
            mo_commented_file_deps=['other_file.c'],
            file_deps=[Path('other_mods.f90')],
            psyclone_kernels={'kernel_one_type': 123, 'kernel_two_type': 456}
        )
    ...
    def different_file_deps(self):
        return AnalysedFortran(
            ...
            symbol_deps=['other_mod1',
                         ...
                         'other_func2'],
            mo_commented_file_deps=['my_file.c'],
            file_deps=[Path('other_mods2.f90')],
            psyclone_kernels={'kernel_one_type': 123, 'kernel_two_type': 456}
        )
    ...
    def as_dict(self):
        return {
            ...
            'module_deps': ['other_mod1', 'other_mod2'],
            'symbol_deps': ['other_func1',
                            'other_func2',
                            'other_mod1',
                            'other_mod2'],
            'mo_commented_file_deps': ['my_file.c'],
            'file_deps': ['other_mods.f90'],
            'psyclone_kernels': {'kernel_one_type': 123,
                                 'kernel_two_type': 456},
        }

    def test_add_module_def(self, analysed_fortran):
        analysed_fortran.add_module_def('my_mod3')
        assert analysed_fortran.module_defs == {'my_mod1',
                                                'my_mod2',
                                                'my_mod3'}
        assert analysed_fortran.symbol_defs == {'my_func1',
                                                'my_func2',
                                                'my_mod1',
                                                'my_mod2',
                                                'my_mod3'}
    ...
    def test_add_module_dep(self, analysed_fortran):
        ...
        assert analysed_fortran.module_deps == {'other_mod1',
                                                'other_mod2',
                                                'other_mod3'}
        assert analysed_fortran.symbol_deps == {'other_func1',
                                                'other_func2',
                                                'other_mod1',
                                                'other_mod2',
                                                'other_mod3'}
    ...
    def test_eq_different_module_defs(self,
                                      analysed_fortran,
                                      different_module_defs):
        assert analysed_fortran != different_module_defs

    def test_eq_different_module_deps(self,
                                      analysed_fortran,
                                      different_module_deps):
        assert analysed_fortran != different_module_deps

    def test_eq_different_mo_commented_file_deps(
            self,
            analysed_fortran,
            different_mo_commented_file_deps
    ):
        assert analysed_fortran != different_mo_commented_file_deps

    def test_eq_different_psyclone_kernels(self,
                                           analysed_fortran,
                                           different_psyclone_kernels):
    ...
    def test_hash_different_module_defs(self,
                                        analysed_fortran,
                                        different_module_defs):
        assert hash(analysed_fortran) != hash(different_module_defs)

    def test_hash_different_module_deps(self,
                                        analysed_fortran,
                                        different_module_deps):
        assert hash(analysed_fortran) != hash(different_module_deps)

    def test_hash_different_mo_commented_file_deps(
            self,
            analysed_fortran,
            different_mo_commented_file_deps
    ):
    ...
    def test_hash_different_psyclone_kernels(self,
                                             analysed_fortran,
                                             different_psyclone_kernels):

...
def file_filtering(config):
    ...
    atmosphere_path = science_root / 'um' / 'atmosphere'
    ukca_control_path = science_root / 'um' / 'control' / 'ukca_interface'

    return [
        Exclude('unit-test', '/test/'),

        Exclude(science_root / 'um'),
        Include(atmosphere_path / 'AC_assimilation/iau_mod.F90'),
        Include(atmosphere_path / 'aerosols'),
        Include(atmosphere_path / 'atmosphere_service'),
        Include(atmosphere_path / 'boundary_layer'),
        Include(atmosphere_path / 'carbon/carbon_options_mod.F90'),
        Include(atmosphere_path / 'convection'),
        Include(atmosphere_path / 'convection' / 'comorph' / 'control'
                / 'comorph_constants_mod.F90'),
        Include(atmosphere_path / 'diffusion_and_filtering'
                / 'leonard_incs_mod.F90'),
        Include(atmosphere_path / 'diffusion_and_filtering'
                / 'turb_diff_ctl_mod.F90'),
        Include(atmosphere_path / 'diffusion_and_filtering/turb_diff_mod.F90'),
        Include(atmosphere_path / 'dynamics'),
        Include(atmosphere_path / 'dynamics_advection'),
        Include(atmosphere_path / 'electric'),
        Include(atmosphere_path / 'energy_correction/eng_corr_inputs_mod.F90'),
        Include(atmosphere_path / 'energy_correction/flux_diag-fldiag1a.F90'),
        Include(atmosphere_path / 'free_tracers/free_tracers_inputs_mod.F90'),
        Include(atmosphere_path / 'free_tracers/water_tracers_mod.F90'),
        Include(atmosphere_path / 'free_tracers/wtrac_all_phase_chg.F90'),
        Include(atmosphere_path / 'free_tracers/wtrac_calc_ratio.F90'),
        Include(atmosphere_path / 'free_tracers/wtrac_move_phase.F90'),
        Include(atmosphere_path / 'idealised'),
        Include(atmosphere_path / 'large_scale_cloud'),
        Include(atmosphere_path / 'large_scale_precipitation'),
        Include(atmosphere_path / 'PWS_diagnostics/pws_diags_mod.F90'),
        Include(atmosphere_path / 'radiation_control/def_easyaerosol.F90'),
        Include(atmosphere_path / 'radiation_control/easyaerosol_mod.F90'),
        Include(atmosphere_path / 'radiation_control'
                / 'easyaerosol_option_mod.F90'),
        Include(atmosphere_path / 'radiation_control'
                / 'easyaerosol_read_input_mod.F90'),
        Include(atmosphere_path / 'radiation_control/fsd_parameters_mod.F90'),
        Include(atmosphere_path / 'radiation_control/max_calls.F90'),
        Include(atmosphere_path / 'radiation_control'
                / 'r2_calc_total_cloud_cover.F90'),
        Include(atmosphere_path / 'radiation_control/rad_input_mod.F90'),
        Include(atmosphere_path / 'radiation_control/solinc_data.F90'),
        Include(atmosphere_path / 'radiation_control/spec_sw_lw.F90'),
        Include(atmosphere_path / 'stochastic_physics'
                / 'stochastic_physics_run_mod.F90'),
        Include(atmosphere_path / 'tracer_advection/trsrce-trsrce2a.F90'),
        ...
        Include(science_root / 'um' / 'control' / 'glomap_clim_interface'
        ...
        Include(ukca_control_path / 'atmos_ukca_callback_mod.F90'),
        Include(ukca_control_path / 'atmos_ukca_humidity_mod.F90'),
        Include(ukca_control_path / 'get_emdiag_stash_mod.F90'),
        Include(ukca_control_path / 'ukca_d1_defs.F90'),
        Include(ukca_control_path / 'ukca_dissoc.F90'),
        Include(ukca_control_path / 'ukca_eg_tracers_total_mass_mod.F90'),
        Include(ukca_control_path / 'ukca_nmspec_mod.F90'),
        Include(ukca_control_path / 'ukca_option_mod.F90'),
        Include(ukca_control_path / 'ukca_photo_scheme_mod.F90'),
        Include(ukca_control_path / 'ukca_radaer_lut_in.F90'),
        Include(ukca_control_path / 'ukca_radaer_read_precalc.F90'),
        Include(ukca_control_path / 'ukca_radaer_read_presc_mod.F90'),
        Include(ukca_control_path / 'ukca_radaer_struct_mod.F90'),
        Include(ukca_control_path / 'ukca_scavenging_diags_mod.F90'),
        Include(ukca_control_path / 'ukca_scavenging_mod.F90'),
        Include(ukca_control_path / 'ukca_tracer_stash.F90'),
        Include(ukca_control_path / 'ukca_um_legacy_mod.F90'),
        Include(ukca_control_path / 'ukca_volcanic_so2.F90'),
        ...
        Include(atmosphere_path / 'COSP/cosp_input_mod.F90'),
        Include(science_root / 'um/control/coupling'),
        Include(science_root / 'um' / 'atmosphere' / 'gravity_wave_drag'
        ...
        Include(science_root / 'um' / 'atmosphere' / 'gravity_wave_drag'
                / 'gw_ussp_mod.F90'),
        Include(atmosphere_path / 'gravity_wave_drag/gw_block.F90'),
        Include(atmosphere_path / 'gravity_wave_drag/gw_wave.F90'),
        Include(atmosphere_path / 'gravity_wave_drag/gw_setup.F90'),
        Include(science_root / 'um' / 'atmosphere' / 'gravity_wave_drag'
                / 'c_gwave_mod.F90'),
        ...
        Include(science_root / 'jules' / 'control' / 'standalone'
                / 'jules_fields_mod.F90'),
        ...
        Include(science_root / 'jules' / 'initialisation' / 'shared'
...
if __name__ == '__main__':
    ...
    with BuildConfig(project_label='atm $compiler $two_stage',
        ...
        # UM physics - versions as required by the LFRIC_REVISION in
        # grab_lfric.py

...
def compile_c(config, common_flags: Optional[List[str]] = None,
    ...
    """
    Compiles all C files in all build trees, creating or extending a set of compiled
    ...
    :param path_flags:
        A list of :class:`~fab.build_config.AddFlags`, defining flags to be included
        in the command line call for selected files.
    :param source:
        An :class:`~fab.artefacts.ArtefactsGetter` which give us our c files to
        process.
    """

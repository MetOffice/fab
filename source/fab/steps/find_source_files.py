...
def find_source_files(config, source_root=None, output_collection="all_source",
    ...
    collection.
    The two convenience subclasses, :class:`~fab.steps.walk_source.Include`
    and :class:`~fab.steps.walk_source.Exclude`, improve readability.
    ...
    so the path *my_folder/my_file.F90* would match filters "my_folder",
    "my_file" and "er/my".

...
def add_mo_commented_file_deps(source_tree: Dict[Path, AnalysedFortran]):
    """
...
def filter_source_tree(source_tree: Dict[Path, AnalysedFortran], suffixes: Iterable[str]):
    """
    ...
    """
    all_files: Iterable[AnalysedFortran] = source_tree.values()
